    ...
    protected function updateGameTeamScore($idGame, $scoreFirstTeam, $scoreSecondTeam, $idTeamWin, $idTeamLose, $pen_1, $pen_2)
    {
        ...
        if ($stmt->execute([
            ...
            if ($currentGame->phase == 'Premier Tour') {
                ...
                $teamController->playGame(
                    intval($currentGame->phase),
                    intval($currentGame->idEquipe1),
                    intval($currentGame->idEquipe2),
                    intval($currentGame->scoreEquipe1),
                    intval($currentGame->scoreEquipe2)
                );
            }
